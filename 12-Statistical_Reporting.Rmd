...
|                 |                                                        |
|-----------------|--------------------------------------------------------|
| **Dates**       | 10 April 2023 - 14 April 2023                            |
...
| **Lectures**    | 12.1: Reporting statistics (21:57 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=e6c873f1-97bf-436c-b62d-af8200d922ad))     |
|                 | 12.2: Getting started with R (18:19 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=ea2bd6fa-4342-4d40-9acc-af8200d9231f))                      |
...
| **Assessments** | [Week 12 Practice quiz](https://canvas.stir.ac.uk/courses/13075/quizzes/30936) on Canvas                     |

# Reporting statistics {#Chapter_36}
...
# _Practical_. Statistical techniques in R {#Chapter_37}
...
Since our p-value is less than 0.05, we can also run a Tukey's Honestly Significant Difference test of multiple comparisons (see [Chapter 24](#Chapter_24)).
...
Note that the output of the correlation test includes the t statistic, which is used for correlation hypothesis testing ([Chapter 29.3](#correlation-hypothesis-testing)).
...
In the one-way ANOVA of [Chapter 37.2.1](#one-way-anova-in-r), we tested if bill length differed among penguin species.
...
Instead of using a one-way ANOVA, we should therefore try the non-parameteric equivalent Kruskall-Wallis H test ([Chapter 25](#Chapter_25)).
...
Recall from [Chapter 25](#Chapter_25) that the Kruskall-Wallis H test uses a $\chi^{2}$ test statistic. 
