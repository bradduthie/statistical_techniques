...
**Download these data here: [soil_organic_carbon.csv](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/soil_organic_carbon.csv)** (right click and "Save Link As...").
