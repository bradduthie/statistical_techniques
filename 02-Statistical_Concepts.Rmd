...
|                 |                                   |
|-----------------|-----------------------------------|
| **Dates**       | 29 January 2024 - 2 February 2024 |
...
|                 | **Advanced:** None
| **Lectures**    | 2.0: Why study statistics? (18:13 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=2a882cde-c91d-46d4-a69d-b0ed0107c153)) |
|                 | 2.1: Populations and samples (6:47 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=6b8661bd-b566-4227-ad70-b0ed0119452f)) |
|                 | 2.2: Types of variables (11:00 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=bbfc830c-a632-4947-b4de-b0ed01194a61)) |
|                 | 2.3: Units, precision, and accuracy (9:06 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=3de0741e-d4fc-48fb-bf2d-b0ed01194e67)) |
|                 | 2.4: Uncertainty propagation (11:44 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=50f78ab7-d337-423f-baf1-b0ed01195356)) |
| **Practical**   | Introduction to jamovi ([Chapter 8](#Chapter_8))        |
|                 |   Room: Cottrell 2A17         |
|                 |   Group A: 31 JAN 2024 (WED) 09:05-11:55 |
|                 |   Group B: 01 FEB 2024 (THU) 12:05-14:55 |
| **Help hours**  | Ian Jones                       |
|                 |   Room: Cottrell 2A21           |
|                 |   02 FEB 2024 (FRI) 15:05-17:55 |
| **Assessments** | [Week 2 Practice quiz](https://canvas.stir.ac.uk/courses/14932/quizzes/35439) on Canvas  |


Week 2 focuses on general statistical concepts, data, and measurement.

[Chapter 4](#Chapter_4) focuses on key concepts that will be used throughout this module.
...
[Chapter 5](#Chapter_5) introduces different variable types. Different types of variables have different characteristics, which will affect how these variables are best visualised in figures and analysed with statistical hypothesis tests introduced later in the semester.
...
[Chapter 6](#Chapter_6) focuses on units of measurement, and how these units are communicated in text.
...
We are not expecting you to memorise all scientific units, so a [table on units](#appendixA_units) is provided.

[Chapter 7](#Chapter_7) will introduce the propagation of measurement errors.
...
[Chapter 8](#Chapter_8) guides you through the Week 2 practical, which is an introduction to jamovi.
