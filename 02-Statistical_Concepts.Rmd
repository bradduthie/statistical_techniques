...
Notice that the final units are in metres per second, which can be written as $m/s$ or $m\:s^{-1}$ (remember that raising $s$ to the $-1$ power is the same as $1/s$; see [Chapter 1](#Chapter_1) for a quick reminder about superscripts).
...
This practical focuses on learning how to work with datasets in jamovi [@Jamovi2022].
...
For an introduction to what jamovi is and why we are using it in this module, see the introduction of this workbook and [Sections 3.3](https://davidfoxcroft.github.io/lsj-book/03-Getting-started-with-jamovi.html#the-spreadsheet)-[3.9](https://davidfoxcroft.github.io/lsj-book/03-Getting-started-with-jamovi.html#summary) of @Navarro2022.
...
**Download these data here: [soil_organic_carbon.csv](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/soil_organic_carbon.csv)** (right click on the links and choose 'Save Link As...', then save it with the extension '.csv').
...
**Download these data here: [fig_fruits.csv](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/fig_fruits.csv)** (right click and "Save Link As...").
...
Some of these exercises will be similar to what we did in the week 1 practical from [Chapter 3](##Chapter_3), but in jamovi rather than a separate spreadsheet.
...
Download the [soil organic carbon](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/soil_organic_carbon.csv) dataset if you have not already done so (right click and "Save Link As..."), and save it in a location where you know you will be able to find it again, then open jamovi.
...
In this next exercise, we will work with the [fig fruits](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/fig_fruits.csv) dataset (right click and "Save Link As...").
...
Choose an appropriate name (e.g., 'SCIU4T4_Week2_practical.omv'), then save the file in a location where you know that you will be able to find it again.
...
Give the file an appropriate name (e.g., 'SCIU4T4_Week2_data'), then choose 'CSV' from the pulldown menu below (Figure 8.10).

```{r, echo = FALSE, fig.alt = "A jamovi Export window is open with a file being saved and the pull down menu below selecting 'CSV' as an option", fig.cap = "The jamovi Export menu in which data are be saved as a CSV using the pulldown menu below the filename", out.width="100%"}
knitr::include_graphics("img/export_jamovi.png")
```
