...
This has been useful when data violate the assumptions of a statistical test, and we need a non-parametric test instead (e.g., the [Wilcoxon signed rank test](#wilcoxon-test-1), the [Mann-Whitney U test](#mann-whitney-u-test-1), or the [Kruskall-Wallis H test](#Chapter_25)).
...
For all of these examples, this practical will use a dataset inspired by the doctoral work of Dr Jessica Burrows [@Burrows2022].
...
Put mass on the x-axis and CO_2 on the y-axis, as shown in Figure 30.5.
