...
[Chapter 23.3](#the-variance) introduced the variance ($s^{2}$) as a measure of spread in some variable $x$,
...
> [Click here](https://bradduthie.shinyapps.io/corr_click/) for an interactive application showing the relationship between a scatterplot, a correlation coefficient, and statistical significant.
...
# *Practical*. Analysis of counts and correlations
...
The practical will use the [bumblebee.csv]() dataset (right click and “Save Link As…”, then save it with the extension ‘.csv’).
