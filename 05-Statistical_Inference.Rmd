...
If you need to download it again, the instructions are in [Chapter 16](#Chapter_16) Exercise 16.2.
...
1. Download distrACTION module if not already downloaded
2. Download the WrEN Trees [wren_trees.xlsx](https://raw.githubusercontent.com/bradduthie/statistical_techniques/main/data/wren_trees.xlsx) dataset and open in a spreadsheet
3. Put the WrEN Trees dataset into a tidy format
4. Calculate the grand mean and standard deviation (for all trees)
