...
| **Reading**     | **Required:**  [INSERT REQURESD]  |
...
```{r, echo = FALSE, fig.alt = "Two cats sitting close together, a large orange one in the back and small black one in the front.", fig.cap = "Two domestic cats sitting side by side with much different body masses.", out.width="100%"}
