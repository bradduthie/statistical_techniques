...
|                 | **Advanced:** None
| **Lectures**    | 3.0: Decimal places and significant figures part 1 (7:52 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=eb8cfc0b-84e2-4f0c-95fc-b262011d5348)) |
|                 | 3.1: Decimal places and significant figures part 2 (7:08 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=e13a4127-3667-4882-85da-b262011d2f07)) |
|                 | 3.2: Graphs (10:29 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a8382c91-fc48-4d17-85b3-b262011d2187)) |
|                 | 3.3: Box-whisker plots (8:07 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=9d31a04f-807a-4a96-99ee-b262011d14d2)) |
|                 | 3.4: The mean (16:52 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=6b471ee8-22eb-4d9e-bb6b-b262011d0978)) |
|                 | 3.5: The mode (6:54 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=923b77cf-5430-4753-8d51-b262011cff0d)) |
|                 | 3.6: The median and quantiles (8:04 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=257b94c3-6c28-450e-8f8c-b262011cf7fa)) |
|                 | 3.7: Mean, mode, median, and resistance (8:35 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=f7c7c1c8-32ef-4c72-8ddd-b262011cef15)) |
|                 | 3.8: The variance (9:40 min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=9b53f765-475b-49c6-9827-b262011cdd47)) |
|                 | 3.9: The standard deviation (6:17  min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=fe532cfc-bc3d-46a2-acc3-b262011cd4eb)) |
|                 | 3.10: Other measures of spread (7:46  min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a00741fe-22e1-4f77-a659-b262011ccb15)) |
|                 | 3.11: Standard error (13:23  min; [Video](https://stirling.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=1a4f15ff-2d3e-4da2-bd55-b262011cc039)) |
| **Lecture**     | Careers session: 05 FEB 2025 (WED) 09:00-10:00 Cottrell LT B4 |
| **Practical**   | Plotting and statistical summaries ([Chapter 14](#Chapter_14))       |
|                 |   Room: Cottrell 2A15         |
...
| **Assessments** | [Week 3 Practice quiz](https://canvas.stir.ac.uk/courses/17581/quizzes/40223) on Canvas  |

Week 3 focuses on descriptive statistics, how to report them, interpret them, and communicate them with graphs.

[Chapter 9](#Chapter_9) focuses on how to interpret numbers with the correct degree of accuracy and precision. 
...
This chapter provides numerical examples and shows the number of decimal places and significant figures for each, and it provides instructions and examples for how to round to a specific number of significant figures.
...
It explains what type of plot is appropriate for a given type of variable (see [Chapter 5](#Chapter_5)). 
Specifically, histograms are shown to be applied to continuous data. 
Barplots and pie charts are shown as useful for categorical data (with a preference for barplots in most cases in the biological and environmental sciences), and box-whisker plots (i.e., boxplots) are presented as a means to show summary statistics for multiple variances simultaneously.

[Chapter 11](#Chapter_11) introduces the first type of summary statistics with measures of central tendency. 
...
For each measure of central tendancy, examples are provided with real numbers, and new mathematical notation is introduced to explain the mean (summation and indexing). 
The ways in which the word 'mode' is used are explained, and instructions are given with examples for calculating the median and quantiles.

[Chapter 12](#Chapter_12) introduces measures of spread. 
...
For all measures of spread, an example with real numbers is provided. 
The range is first explained as the maximum value of a variable minus the minimum value. 
Inter-quartile range (IQR) is then explained as the third quartile minus the first quartile. 
A considerable amount of text is then used to explain the variance, with a focus on calculating the sum of squares and the need to account for correct degrees of freedom. 
Degrees of freedom is then explained in general terms. 
The standard deviation and the coefficient of variation are then presented with a brief explanation of when and why they are used. 
Lastly, the standard error is explained and noted as being a bit different from the other measurements in that it is measuring the standard deviation of the sample means around the true mean.

[Chapter 13](#Chapter_13) explains the concepts of skew and kurtosis, and statistical moments. 
...
The third and fourth moment are shown in the context of the equation for variance to help link the key concepts of this chapter with prior material.

[Chapter 14](#Chapter_14) is a guide to using jamovi for making plots introduced in Chapter 10, specifically histograms and box-whisker plots. 
It also focuses on finding measures of central tendency and spread introduced in Chapter 11 and Chapter 12, respectively, in jamovi, and reporting them accurately using the knowledge from Chapter 9. 
Five exercises are introduced in total. 
These exercises use hypothetical measurements of petiole diameter from the white water lily (*Nymphaea alba*), which is found in different sites across Scotland. 
Exercises rely on the Descriptives option in jamovi for plotting and calculating summary statistics.


# Decimal places, significant figures, and rounding {#Chapter_9}

When making calculations, it is important that any numbers reported are communicated with the appropriate [accuracy and precision](#Chapter_6). 
...
But reporting 2.7 only implies that we know the value is somewhere between 2.65 and 2.75 [@Sokal1995].
...
These are the number of digits that you need to infer the accuracy of a value [@Rahman1968]. 
...
In contrast, the measurement 0.045000 has 5 significant figures because the last 3 zeros indicate a higher degree of accuracy than just 0.045 would (i.e., we know the value is somewhere between 0.044995 and 0.045005, not just 0.0445 and 0.0455). 
...
Table: **TABLE 9.1** Numbers are presented with columns indicating their decimal places and significant figures.

It is a good idea to double-check that the values in these tables make sense.
Make sure you are confident that you can report numbers to a given number of decimal places or significant figures.

## Rounding

Often if you want to report a number to a specific number of decimals or significant figures, you will need to round the number. 
...
There are different rules for rounding numbers, but this book will follow @Sokal1995.
...
Table: **TABLE 9.2** Numbers to be rounded are presented in rows of the first column. The significant figures to which rounding is desired is in the second column, and the third column shows the correctly rounded number.
...
In general, it is also best to make the simplest graph possible for visualising the data, which means avoiding unnecessary colour, three-dimensional display, or distractions from the information being conveyed [@Dytham2011; @Kelleher2011]. 
...
The histogram shown in Figure 10.1 provides an example using the fig fruits dataset from the practical in [Chapter 8](#Chapter_8) (an interactive application[^shiny_build_histogram] shows a step-by-step demonstration of how a histogram is built).
...
The bars of the histogram touch each other, which reinforces the idea that the data are continuous [@Dytham2011; @Sokal1995].
...
For the purposes of this book, the *shape* of the distribution just means what the data look like when plotted like this in a histogram. 
...
Different distribution shapes will be discussed more in [Chapter 15](#Chapter_15).

[^shiny_build_histogram]: https://bradduthie.github.io/stats/app/build_histogram/
...
For example, in the fig fruits dataset from [Chapter 8](#Chapter_8), `r dim(fig_fruits)[1]` fig fruits were collected from four different trees (A, B, C, and D). 
A barplot could be used to show how many samples were collected from each tree (see Figure 10.2).

```{r, echo = FALSE, fig.alt = "An example barplot shows the total number of fruits collected from four trees labelled A, B, C, and D.", fig.cap = "Example barplot showing how many fruits were collected from each of four trees (78 collected in total) in 2010 from Baja, Mexico.", out.width="100%"}
...
```{r, echo = FALSE, fig.alt = "An example pie chart shows the percentage of fruits collected from four trees labelled A, B, C, and D.", fig.cap = "Example pie chart showing the percentage of fruits that were collected from each of four trees (78 collected in total) in 2010 from Baja, Mexico.", out.width="100%"}
...
In contrast to pie charts, barplots present absolute quantities (in Figure 10.2, e.g., the actual number of fruits sampled per tree), and it is still possible with barplots to infer the percentage each category contributes to the total from the relative sizes of the bars.
Pie charts, in contrast, only illustrate relative percentages unless numbers are used to indicate absolute quantities.
Unless percentage alone is important, barplots are often the preferred way to communicate categorical data.
...
These summary statistics include the median (circles), quartiles (squares), and the limits of the distribution (i.e., minimum and maximum values; triangles).
Note that in boxplots, if outliers exist, they are presented as separate points.

```{r, echo = FALSE, fig.alt = "Example of a simple boxplot shown to the left of a histogram, each showing the same information, with points showing how properties of the two panels match.", fig.cap = "Boxplot (A) of fig fruit widths (cm) for 78 fig fruits collected in 2010 in Baja, Mexico. Panel A presents the same data as a histogram. Points in the boxplot indicate the median (circle), first and third quartiles (squares), and the limits of the distribution (triangles). Corresponding locations are shown on the histogram in panel B.", out.width="100%"}
par(mfrow = c(1, 2));
...
```{r, echo = FALSE, fig.alt = "Example of boxplot showing the distributions of fig fruit width for four different trees.", fig.cap = "Boxplot of fig fruit widths (cm) collected from four separate trees sampled in 2010 from Baja, Mexico.", out.width="100%"}
...
Summary statistics describe properties of data in a single number (e.g., mean), or a set of numbers (e.g., quartiles).
This chapter focuses on summary statistics that describe the centre of a distribution.
It also introduces quantiles, which divide a distribution into different percentages of the data (e.g., lowest 50\% or highest 75\%).
...
This book focuses on statistical techniques, not statistical theory, so summary statistics will just focus on how to estimate statistics from sampled data instead of how statistics are defined mathematically[^miller_textbook].

[^miller_textbook]: A good textbook for learning about theoretical statistics and the mathematics underlying the techniques in this book is @Miller2004.

##  The mean

The arithmetic mean (hereafter just *the mean*[^other_means]) of a sample is one of the most commonly reported statistics when communicating information about a dataset. 
...
| Symbol | $x_{1}$ | $x_{2}$ | $x_{3}$ | $x_{4}$ | $x_{5}$ | $x_{6}$ | $x_{7}$ | $x_{8}$ |
|:------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|
| Value  |   4.2   |   5.0   |   3.1   |   4.2   |   3.8   |   4.6   |   4.0   |   3.5   |

Table: **TABLE 11.1** Sample dataset that includes eight values.
...
[^other_means]: There are other types of means, such as the geometric mean or the harmonic mean, but we will not use these at all.
...
If there is an odd number of values in the dataset, then finding the median is often easy.
...
There are at least nine different ways to calculate the first quartile in this case, and different statistical software packages will sometimes use different default methods [@Hyndman1996].
...
If we want to be technical, then we can write a general equation for the range of a random variable $X$,
...
The range of plant A would then be $19.7 - 4.7 = 15$ instead of 0.6.
...
The first quartile will be 4.95.
...
We will start with the variance; this section is long because I want to break the variance down carefully, step by step.
...
This is what the sum of squares calculation looks like written out,
...
Jamovi will do all of these steps and calculate the variance for us ([Chapter 14](#Chapter_14) explains how).
...
Moreover, if we did not square the values, then the sum of $x_{i} - \bar{x}$ values would always be 0 (you can try this yourself)[^why_square].
Lastly, it turns out that the variance is actually a special case of a more general concept called the *covariance*, which we will look at later in [Chapter 30](#Chapter_30) and which helps the squaring of differences make a bit more sense.
...
By subtracting 1, we are correcting for this bias to get a more accurate estimate of the population variance[^true_pop_var].
It is not necessary to do this ourselves; jamovi will do it automatically [@Jamovi2022].
The subtraction is required due to a reduction in the *degrees of freedom* that occurs when using the sample mean in the equation for variance[^df_for_var].

**Degrees of freedom** is a difficult concept to understand, but we can broadly define the degrees of freedom as the number of independent pieces of information that we have when calculating a statistic [@Grafen2002; @Upton2014].
When we need to estimate a parameter from a dataset in the process of calculating a statistic, we lose an independent piece of information, and therefore a degree of freedom [@Pandey2008].
...
To calculate the variance, we use all of these 10 samples *and* $\bar{x}$ (note that $\bar{x}$ appears in the equation for variance above).
...
We therefore lose a degree of freedom by including $\bar{x}$ in the calculation of variance, so we need to divide by $N - 1$ rather than $N$ to avoid bias [@Wardlaw1985; @Fowler1998].
Another way of thinking about degrees of freedom is as the number of differences that can arise between what we sample versus what we expect just based on the mathematics [@Fryer1966].
...
That is, for the example of plant leaf mass in grams, the variance is measured in grams squared, $\mathrm{g^{2}}$, which is not particularly easy to interpret.
...
For example, variances are additive, meaning that if we are measuring two separate characteristics of a sample, A and B, then the variance of A+B equals the variance of A plus the variance of B, i.e., $\mathrm{Var}(A + B) = \mathrm{Var}(A) + \mathrm{Var}(B)$.[^uncorrelated_caveat]
...
For plant A, we calculated a leaf mass variance of $s^{2} = 0.0333\:\mathrm{g^{2}}$, which means that the standard deviation of leaf masses is $s = \sqrt{0.0333\:\mathrm{g^{2}}} = 0.1825\:\mathrm{g}$.
...
To help with the interpretation, an interactive tool can more effectively show how the heights of trees in a forest change across different standard deviation values[^shiny_forest].
Another interactive tool can help show how the shape of a histogram changes when the standard deviation of a distribution is changed[^calculate_sd_jamovi].
[Chapter 14](#Chapter_14) explains how to calculate the standard deviation in jamovi.

[^shiny_forest]: https://bradduthie.github.io/stats/app/forest/

[^calculate_sd_jamovi]: https://bradduthie.github.io/stats/app/normal_pos_neg/
...
For example, for the leaf masses of plant A, we calculated a standard deviation of 0.1825 $\mathrm{g}$ and a mean of 5 $\mathrm{g}$.
...
The standard error of the mean is the last measure of spread that I will introduce.
It is slightly different than the previous measurements in that it is a measure of the variation in the *mean* of a sample rather than the sample itself.
...
We will calculate confidence intervals in [Chapter 18](#Chapter_18), so it is important to understand what the standard error is measuring.
...
while(se_diff > 0.0025){
  ...
  water_se_names  <- paste("S", 1:20, sep = "");
...
This time, however, assume that we somehow *know* that the true mean nitrogen concentration is $\mu = 0.7$, and that the true standard deviation of water sample nitrogen concentration is $\sigma = 0.1$.
...
```{r, echo = FALSE}
pander::pander(format(water_se_array, nsmall = 2), format = "simple", table.envir = "table",
             caption = "**TABLE 12.1** Simulated samples (S1-S20) of nitrogen content from water samples of Airthrey Loch. Values are sampled from a normal distribution with a mean of 0.7 and a standard deviation of 0.1.");
```
...
# Skew and kurtosis {#Chapter_13}

Following measures of central tendency in [Chapter 11](#Chapter_11) and measures of spread in [Chapter 12](#Chapter_12), there are two more concepts that are worth briefly mentioning.
...
The **skew** of a distribution refers to its asymmetry [@Sokal1995; @Dytham2011], which can be observed in a histogram (Figure 13.1).
...
```{r, echo = FALSE, fig.alt = "Two histograms are shown side by side. The histogram on the left looks normal, but with an extended tail on the left hand side. The histogram on the right also looks normal, but with an extend tail on the right hand side.", fig.cap = "Histograms showing a (A) distribution that has a negative (i.e., 'left') skew and (B) distribution that has a positive (i.e., 'right') skew.", out.width="100%"}
...
When a distribution is skewed, the mean and median of the distribution will be different [@Sokal1995].
...
This can be important when interpreting the median versus mean as a measure of central tendency [@Reichmann1970].
For example, household income data are typically highly right-skewed because a small proportion of households have a much higher income than the typical household [@Mcdonald2013].
Consequently, when data are strongly skewed, the mean and median give us different information, and it often makes sense to use the median as an indication of what is typical [@Chiripanhura2011].


## Kurtosis

The **kurtosis** describes the extent to which a distribution is flat.
In other words, whether data tend to be in the centre and at the tails, or whether data tend to be between the centre and tails [@Sokal1995].
If there are more values in the centre and tails of the distribution, then the distribution is described as 'leptokurtic' (Figure 13.2A).
If there are more values between the centre and the tails, then the distribution is described as 'platykurtic' (Figure 13.2B).

```{r, echo = FALSE, fig.alt = "Two histograms are shown side by side. The histogram on the left looks normal, but with more values in the centre and toward the extreme sides. The histogram on the right also looks normal, but with relatively few values in the centre and at the extremes.", fig.cap = "Histograms showing a (A) leptokurtic distribution and (B) platykurtic distribution.", out.width="100%"}
...
The extent to which any given distribution is leptokurtic versus platykurtic is defined relative to the normal distribution, which will be introduced in [Chapter 15](#Chapter_15).
...
It is possible to actually calculate skew and kurtosis as we would measures of central tendency and spread [@Rahman1968; @Groeneveld1984; @Sokal1995], but this is very rarely necessary [but see @Doane2011].
...
In statistics, a **moment** is related to how much some value (more technically, a random variable) is expected to deviate from the mean [@Upton2014].
The term has its origins in physics [@Sokal1995; @Miller2004].
...
The corrections now also need to be scaled by the standard deviation [for details, see @Sokal1995].
...
# _Practical_. Plotting and statistical summaries in jamovi {#Chapter_14}

This chapter focuses on applying the concepts from Chapters 9--13 in jamovi [@Jamovi2022]. 
The data that we will work with in this chapter were inspired by @Law2014.
@Law2014 focused on beaver reintroduction in Scottish habitats and investigated its consequences for the white water lily, *Nymphaea alba*, which beavers regularly consume.

This chapter will analyse data on the petiole diameter (mm) from *N. alba* collected from seven different sites on the west coast of Scotland (the petiole is the structure that attaches the plant stem to the blade of the leaf).
The *N. alba* dataset is available online[^Nymphaea_dataset]. 
The data are not in a tidy format, so it is important to first reorganise the data so that they can be analysed in jamovi.
Once the data are properly organised, we will use jamovi to plot them, calculate summary statistics, apply appropriate decimals, significant figures, and rounding, and compare petiole diameters across sites.

[^Nymphaea_dataset]: [https://bradduthie.github.io/stats/data/Nymphaea_alba.csv](https://bradduthie.github.io/stats/data/Nymphaea_alba.csv)

## Reorganise the dataset into a tidy format

The *N. alba* dataset is not in a tidy format. 
All of the numbers from this dataset are measurements of petiole diameter in millimetres from *N. alba*, but each row contains seven samples because each column shows a different site.
...
```{r, echo = FALSE, fig.alt = "Jamovi interface is shown with new columns being added to the dataset.", fig.cap = "Tidying the raw data of petiole diameters from lily pad measurements across seven sites in Scotland. A new column of data is created by right-clicking on an existing column and choosing 'Add Variable'.", out.width="100%"}
...
Instead of one histogram of petiole diameters, you will now see seven different histograms, one for each site, all stacked on top of each other.
This might be useful, but all of these histograms together is a bit busy.
...
There is one more trick that is useful with box-whisker plots in jamovi.
...
To calculate all of the variables explained in [Chapter 11](#Chapter_11) and [Chapter 12](#Chapter_12), check the following 11 boxes:
...
Which of the seven sites in the dataset has the highest mean petiole diameter, and what is its mean?
...
Remember from Section 14.2 that you were asked to write down what you thought the mean, median, and standard deviation were just by inspecting the histogram.
...
If we were to go back out to these seven sites and sample another 20 petiole diameters, could we **really** expect to get the exact same site means?
