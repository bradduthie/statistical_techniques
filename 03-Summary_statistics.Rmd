...
For example, in the [fig fruits](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/fig_fruits.csv) data set from [Chapter 8](#Chapter_8) (right click and "Save Link As..."), `r dim(fig_fruits)[1]` fig fruits were collected from 4 different trees (A, B, C, and D). 
...
The *N. alba* dataset is available to download [here](https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/Nymphaea_alba.csv)  (right click and "Save Link As...").
