...
For each weak, links to all chapters, lectures, and quizzes are available in this book (e.g., the [Week 1 Overview](#Week1)), and on the [Learning and Teaching](https://canvas.stir.ac.uk/courses/13075/pages/learning-and-teaching) page on Canvas.


### Book chapters {-#book_chapters}

The book chapters that you need to read for each week are all listed at the start of each section in this book (e.g., [Week 1](#Week1)), and in each week's [Learning and teaching content](https://canvas.stir.ac.uk/courses/13075/pages/learning-and-teaching) on Canvas.
...
|------------------|------------|------------|-------|-----------------------|
| [Test 1F](https://canvas.stir.ac.uk/courses/13075/quizzes/29676)          | Formative  | 0\%        | 1-4   | 22 FEB at 10:00-12:00 |         
| [Test 1S](https://canvas.stir.ac.uk/courses/13075/quizzes/29677)          | Summative  | 25\%       | 1-6   | 15 MAR at 10:00-12:00 |
| [Test 2S](https://canvas.stir.ac.uk/courses/13075/quizzes/29678)          | Summative  | 25\%       | 7-10  | 05 APR at 10:00-12:00 |
| [Mock Exam](https://canvas.stir.ac.uk/courses/13075/quizzes/29679)        | Formative  | 0\%        | All   | To be determined      |
| [Exam](https://canvas.stir.ac.uk/courses/13075/quizzes/29680)             | Summative  | 50\%       | All   | To be determined      |
...
You can access the assessments in the table above using the '[Quizzes](https://canvas.stir.ac.uk/courses/13075/quizzes)' link on canvas, or access an assessment directly with the above links.
...
This year, and for the foreseeable future, we are using [Jamovi](https://www.jamovi.org/) [@Jamovi2022].
...
knitr::kable(schedule, format = "simple", table.envir = "table",
             caption = "Dates, times, and locations of all synchronous activities in Statistical Techniques for Spring 2023.");
```
