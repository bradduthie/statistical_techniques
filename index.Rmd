...
- **Practical Group A**: WED 09:05-11:55 in Cottrell 2A17
- **Practical Group B**: THU 12:05-14:55 in Cottrell 2A17
- **Optional Help**: FRI 15:05-17:55 in Cottrell 2A21
...
| Lecture videos   | Optional help sessions  |
| Practice quizzes |                         |

Table: Summary of online and face-to-face teaching.

For each weak, links to all chapters, lectures, and quizzes are available in this book (e.g., the [Week 1 Overview](#Week1)), and on the [Learning and Teaching](https://canvas.stir.ac.uk/courses/14932/pages/learning-and-teaching) page on Canvas.


### Book chapters {-#book_chapters}

The book chapters that you need to read for each week are all listed at the start of each section in this book (e.g., [Week 1](#Week1)), and in each week's [Learning and teaching content](https://canvas.stir.ac.uk/courses/14932/pages/learning-and-teaching) on Canvas.
...
You should be enrolled in the University of Stirling Canvas module "SCIU4T4 - Statistical Techniques (2023/4)". 
...
Similarly, weekly links to readings, lectures, practicals, and assessments are posted at the start of the sections of this book and in the [Learning and Teaching](https://canvas.stir.ac.uk/courses/14932/pages/learning-and-teaching) content on Canvas.
...
- **[Discussions](https://canvas.stir.ac.uk/courses/14932/discussion_topics)** are a place where you can ask questions about the module. Each week, a new topic will be introduced so that you can ask questions pertaining to that week (we are not strict about which week you post in; this is more just to help keep everything organised). You can also ask questions anonymously on the **[SCIU4T4 Padlet](https://padlet.com/alexanderduthie/ox0i6vbgakpvb47b)**. It is completely fine to ask for practice problems in the discussion boards, but please try to be as specific as possible about what you want to practice (this helps us come up with good questions).
- **[Quizzes](https://canvas.stir.ac.uk/courses/14932/quizzes)** are where all practice quizzes and assessments will be located. You must take these on Canvas, and you will need a laptop or desktop computer to complete them.
- **[People](https://canvas.stir.ac.uk/courses/14932/users)** is where you can sign up for a practical group (A or B).
...
|------------------|------------|------------|-------|-----------------------|
| [Test 1F](https://canvas.stir.ac.uk/courses/14932/quizzes/35457)          | Formative  | 0\%        | 1-4   | 21 FEB at 12:05-13:55 |         
| [Test 1S](https://canvas.stir.ac.uk/courses/14932/quizzes/35456)          | Summative  | 25\%       | 1-6   | 13 MAR at 12:05-13:55 |
| [Test 2S](https://canvas.stir.ac.uk/courses/14932/quizzes/35453)          | Summative  | 25\%       | 7-10  | 05 APR at 12:05-13:55 |
| [Mock Exam](https://canvas.stir.ac.uk/courses/14932/quizzes/35444)        | Formative  | 0\%        | All   | To be determined      |
| [Exam](https://canvas.stir.ac.uk/courses/14932/quizzes/35455)             | Summative  | 50\%       | All   | To be determined      |
...
You can access the assessments in the table above using the '[Quizzes](https://canvas.stir.ac.uk/courses/14932/quizzes)' link on canvas, or access an assessment directly with the above links.
...
Practical sessions are held in room Cottrell 2A17 on either Wednesdays from 09:05-11:55 (Group A) or Thursdays from 12:05-14:55 (Group B).
...
Face-to-face help is available to you every Friday in room Cottrell 2A21 from 15:05-17:55.
...
You can also run jamovi [from a browser](https://www.jamovi.org/cloud.html), but there are currently some time limitations for doing this (sessions are limited to 45 minutes).
...
knitr::kable(schedule, format = "simple", table.envir = "table",
             caption = "Dates, times, and locations of all synchronous activities in Statistical Techniques for Spring 2024.");
```
