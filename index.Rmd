...
We are committed to making this module accessible, which is why the material in this book is available in multiple formats (online, [audiobook](https://open.spotify.com/show/3mtZ9C9JFV0rdCm2Mf1IRf)).
...
The learning content of this module will be delivered in lectures, lab practicals, and optional drop-in help sessions.
...
If possible, it is probably best to read and focus on the lectures before the weekly practical, then take the quiz after the practical.
Weekly practicals are on Wednesday morning (Group A) or Thursday morning (Group B), depending on which group you sign up for (you only need to attend one).
Weekly face-to-face lectures are Mondays at 11:00 and Wednesdays at 09:00, and optional help sessions are on Friday afternoons from 11:00-13:00.

- **Lectures**: 
    - MON: 11:00-12:00 in Logie Lecture Theatre (Weeks 1-6, 8-12)
    - WED: 09:00-10:00 in Cottrell LT A4 (Weeks 1-5, 8-12) and LT B4 (Week 6)
- **Practical Group A**: 
    - WED 11:00-14:00 in Cottrell 2A15 (Weeks 1-6, 7, 8, 10-12) and Cottrell 1A11 (Week 9)
- **Practical Group B**: 
    - THU 09:00-12:00 in Cottrell 2A15 (Weeks 1-6, 8-12)
- **Optional Help**: 
    - FRI 11:00-13:00 in Cottrell 1A11 (Weeks 1-6, 8-10, 12)
    - MON 14:00-16:00 in Cottrell 2A15 (Week 13)
...
For each weak, links to all chapters, lectures, and quizzes are available in this book (e.g., the [Week 1 Overview](#Week1)), and on the [Learning and Teaching](https://canvas.stir.ac.uk/courses/19303/pages/learning-and-teaching) page on Canvas.


### Book chapters {-#book_chapters}

The book chapters that you need to read for each week are all listed at the start of each section in this book (e.g., [Week 1](#Week1)), and in each week's [Learning and teaching content](https://canvas.stir.ac.uk/courses/19303/pages/learning-and-teaching) on Canvas.
...
> [Click here](https://bradduthie.github.io/stats/app/forest/) for an example interactive application.
...
You should be enrolled in the University of Stirling Canvas module "SCIU4T4 - Statistical Techniques (2025/6)". 
...
In Canvas, you will find links to all learning content, including chapters to this book, lecture recordings, practice quizzes, tests, and exams.
...
Similarly, weekly links to readings, lectures, practicals, and assessments are posted at the start of the sections of this book and in the [Learning and Teaching](https://canvas.stir.ac.uk/courses/19303/pages/learning-and-teaching) content on Canvas.
...
- **[Discussions](https://canvas.stir.ac.uk/courses/19303/discussion_topics)** are a place where you can ask questions about the module. Each week, a new topic will be introduced so that you can ask questions pertaining to that week (we are not strict about which week you post in; this is more just to help keep everything organised). You can also ask questions anonymously in the **[Anonymous questions](https://canvas.stir.ac.uk/courses/19303/discussion_topics/363669)** discussion. It is completely fine to ask for practice problems in the discussion boards, but please try to be as specific as possible about what you want to practice (this helps us come up with good questions).
- **[Quizzes](https://canvas.stir.ac.uk/courses/19303/quizzes)** are where all practice quizzes and assessments will be located. You must take these on Canvas, and you will need a laptop or desktop computer to complete them.

In general, it is probably also easiest to watch recordings of lectures from within Canvas, although this should also be possible outside of Canvas using links in this book.
...
|------------------|------------|------------|-------|-----------------------|
| [Test 1F](https://canvas.stir.ac.uk/courses/19303/quizzes/44177)          | Formative  | 0\%        | 1-4   | 18 FEB at 15:00-17:00 |         
| [Test 1S](https://canvas.stir.ac.uk/courses/19303/quizzes/44182)          | Summative  | 25\%       | 1-6   | 11 MAR at 15:00-17:00 |
| [Test 2S](https://canvas.stir.ac.uk/courses/19303/quizzes/44191)          | Summative  | 25\%       | 7-10  | 01 APR at 15:00-17:00 |
| [Mock Exam](https://canvas.stir.ac.uk/courses/19303/quizzes/44181)        | Formative  | 0\%        | All   | To be determined      |
| [Exam](https://canvas.stir.ac.uk/courses/19303/quizzes/44179)             | Summative  | 50\%       | All   | To be determined      |
...
You can access the assessments in the table above using the '[Quizzes](https://canvas.stir.ac.uk/courses/19303/quizzes)' link on canvas, or access an assessment directly with the above links.
...
This report will be made available to you on Canvas within 21 days of the assessment (in practice, we will try to get assessments graded as quickly as possible).
...
Practical sessions are held in room Cottrell 2A15 on either Wednesdays (Group A) or Thursdays (Group B), except for Week 9 when Group A is in Cottrell 1A11.
...
Face-to-face help is available to you every Friday in room Cottrell 1A11 from 11:00-13:00.
...
```{r, echo = FALSE, fig.cap = "Dates, times, and locations of all synchronous activities in Statistical Techniques for Spring 2026."}
schedule <- read.csv("data/schedule.csv");
knitr::kable(schedule, format = "simple", table.envir = "table",
             caption = "Dates, times, and locations of all synchronous activities in Statistical Techniques for Spring 2026.");
```
